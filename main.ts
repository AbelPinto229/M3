...
// Import all services
import { UserService } from './PROJETO 2 M3/src/services/UserService.js';
import { TaskService } from './PROJETO 2 M3/src/services/TaskService.js';
import { SystemLogger } from './PROJETO 2 M3/src/logs/SystemLogger.js';
import { CommentService } from './PROJETO 2 M3/src/services/CommentService.js';
import { AttachmentService } from './PROJETO 2 M3/src/services/AttachmentService.js';
import { TagManager } from './PROJETO 2 M3/src/utils/TagManager.js';
import { DeadlineService } from './PROJETO 2 M3/src/services/DeadlineService.js';
import { PriorityService } from './PROJETO 2 M3/src/services/PriorityService.js';
import { AssignmentService } from './PROJETO 2 M3/src/services/AssignmentService.js';
import { SearchService } from './PROJETO 2 M3/src/services/SearchService.js';
import { StatisticsService } from './PROJETO 2 M3/src/services/StatisticService.js';
import { BackupService } from './PROJETO 2 M3/src/services/BackupService.js';
import { AutomationRulesService } from './PROJETO 2 M3/src/services/AutomationRulesService.js';
import { NotificationService } from './PROJETO 2 M3/src/notifications/NotificationService.js';

// Import UI components
import { RenderUser } from './PROJETO 2 M3/src/ui/renderUser.js';
import { RenderTask } from './PROJETO 2 M3/src/ui/renderTask.js';
import { RenderModals } from './PROJETO 2 M3/src/ui/renderModals.js';
import { User } from './PROJETO 2 M3/src/models/Users.js';
import { Task } from './PROJETO 2 M3/src/models/Task.js';
import { Paginator } from './PROJETO 2 M3/src/utils/Paginator.js';
import { Favorites } from './PROJETO 2 M3/src/utils/Favorites.js';
import { WatcherSystem } from './PROJETO 2 M3/src/utils/WatcherSystem.js';
import { PriorityManager } from './PROJETO 2 M3/src/utils/PriorityManager.js';
import { RatingSystem } from './PROJETO 2 M3/src/utils/RatingSystem.js';
import { DependencyGraph } from './PROJETO 2 M3/src/utils/DependencyGraph.js';
import { IdGenerator } from './PROJETO 2 M3/src/utils/IdGenerator.js';
import { SystemConfig } from './PROJETO 2 M3/src/services/SystemConfig.js';
import { BusinessRules } from './PROJETO 2 M3/src/services/BusinessRules.js';
import { GlobalValidators } from './PROJETO 2 M3/src/utils/GlobalValidators.js';
import { BaseEntity } from './PROJETO 2 M3/src/models/BaseEntity.js';
...
const appContext: AppContext = {
  ...
  checkPermission: function(action) {
    ...
    return (permissions as any)[action]?.includes(role) || false;
  },
...
function setProgressBar(id: string, width: string | number) {
  const el = document.getElementById(id);
...
function setFilterButton(btn: HTMLElement, active: boolean) {
  if (!btn) return;
  if (active) {
...
function setupSearchAndFilterListeners() {
  ...
  sortAZBtn?.addEventListener('click', () => {
    ...
    if (sortAZBtn) sortAZBtn.textContent = texts[window.appContext.taskSortState as keyof typeof texts];
    window.appContext.renderTask.render();
  });
